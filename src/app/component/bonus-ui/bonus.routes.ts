...
export const BonusUi: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "dropzone",
        loadComponent: () =>
          import("./dropzone/dropzone").then((m) => m.Dropzone),
        data: {
          title: "Dropzone",
          breadcrumb: "Dropzone",
        },
      ...
      },
      {
        path: "pagination",
        loadComponent: () =>
          import("./paginations/paginations").then((m) => m.Paginations),
        data: {
          title: "Paginations",
      ...
      },
      {
        path: "breadcrumb",
        loadComponent: () =>
          import("./bredcrumb/bredcrumb").then((m) => m.Bredcrumb),
        data: {
          title: "Breadcrumb",
      ...
      },
      {
        path: "range-slider",
        loadComponent: () =>
          import("./rang-slider/rang-slider").then((m) => m.RangSlider),
        data: {
          title: "Range Slider",
      ...
      },
      {
        path: "basic-card",
        loadComponent: () =>
          import("./basic-card/basic-card").then((m) => m.BasicCard),
        data: {
          title: "Basic Card",
