...
export const iconbadge: button[] = [
  {
    ...
    item: [
      ...
      {
        class: "badge b-ln-height badge-warning p-2 text-dark",
        icon: "dollar-sign",
        icon_enble: true,
      },
      {
...
export const iconpills: button[] = [
  {
    ...
    title:
      "<span>Use the</span><code>.badge</code><span> utility class to make more icons.</span>",
    item: [
      {
      ...
      {
        class: "badge b-ln-height badge-warning rounded-pill p-2 text-dark",
        icon: "dollar-sign",
        icon_enble: true,
      },
      {
