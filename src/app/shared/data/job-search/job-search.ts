...
export const jobCardsData: jobData[] = [
  {
    ...
    desc: "We are looking for an experienced and Crocs designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating closely with other...",
    tag: true,
    tagTitle: "New",
    tagColor: "primary",
    ribbion: false,
  ...
  },
  {
    ...
    title: "UI/UX IT Frontend Developer",
    subTitle: "(L6) Salt Lake City, UT",
    desc: "We are looking for an experienced and Dunzo designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating closely with other...",
    tag: true,
    tagTitle: "New",
    tagColor: "primary",
    ribbion: false,
