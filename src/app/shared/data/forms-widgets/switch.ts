...
export const commonSwitch = [
  {
    ...
    subdes:
      "<span>Use the</span><code>.switch-state-*icon-state-*</code><span>through defined icons switches.</span>",
    item: [
      {
        divclass: "flex-shrink-0 text-end icon-state",
        colorclass: "primary",
        text: "Primary Switch",
        value: true,
      },
  ...
  },
  {
    ...
    class: "col-xl-4 col-sm-6",
    subdes:
      "<span>Use the</span><code>.bg-*</code><span>class through created default switches.</span>",
    item: [
      {
        divclass: "flex-shrink-0 text-end",
        colorclass: "primary",
  ...
  },
  {
    ...
    class: "col-xl-4",
    subdes:
      "<span>Use the</span><code>.icon-state-*.switch-outline-*</code><span>class through created outline and icons.</span>",
    item: [
      {
        divclass: "flex-shrink-0 text-end icon-state switch-outline",
        colorclass: "primary",
