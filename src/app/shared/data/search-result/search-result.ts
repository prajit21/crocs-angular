...
export const allData: all[] = [
  {
    ...
    desc: "2024's best selling creative wp themes. the #1 source of premium wp themes! themeforest 45,000+ wp themes & website templates from $2. check it out!",
    rating: 3,
    votes: 590,
    type: "Theme",
    showRating: false,
  ...
  },
  {
    ...
    desc: "Dunzo introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.",
    rating: 3,
    votes: 590,
    type: "Theme",
    showRating: true,
