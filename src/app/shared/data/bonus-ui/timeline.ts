...
export const VeriationTimeline = [
  {
    id: 1,
    dateTime:
      '<span class="date-content light-background txt-dark">8th March, 2022 </span><span>1 day ago</span>',
    colorClass: "primary",
    title: "Updated Product",
    text: "Quisque a consequat ante sit amet magna...",
    class: "f-light",
  },
  {
    id: 2,
    dateTime:
      '<span class="date-content light-background txt-dark">5th Feb, 2024 </span><span>Today</span>',
    colorClass: "warning",
    ...
    data: [
      ...
      {
        img: "assets/images/dashboard-2/product/14.png",
      },
    ],
  },
  {
    id: 3,
    dateTime:
      '<span class="date-content light-background txt-dark">20th Sep, 2022 </span><span>12:00 PM</span>',
