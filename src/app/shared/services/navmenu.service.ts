...
export class NavmenuService {
  ...
  public MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      children: [
        {
          path: "/ecommerce/private-chat",
          title: "Private Chat",
          type: "link",
        },
        { path: "/ecommerce/group-chat", title: "Group Chat", type: "link" },
      ],
    },
    {
      id: 9,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: "https://admin.pixelstrap.com/crocs/template/basic-template.html",
              title: "Basic Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.com/crocs/template/email-header.html",
              title: "Basic With Header",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.com/crocs/template/template-email.html",
              title: "Ecomerce Template",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.com/crocs/template/template-email-2.html",
              title: "Email Template 2",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.com/crocs/template/ecommerce-templates.html",
              title: "Ecommerce Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.com/crocs/template/email-order-success.html",
              title: "Order Success",
              type: "extTabLink",
            },
          ],
